...
if event == 'death':
    ...
    death_mean.to_csv ('results/'+foldername+'_prediction/death_mean_.csv', index = False, header=True)
    death_lower.to_csv ('results/'+foldername+'_prediction/death_lowerBound_.csv', index = False, header=True)
    death_higher.to_csv ('results/'+foldername+'_prediction/death_upperBound_.csv', index = False, header=True)
   ...
   # results_death.to_csv ('results/Future_prediction/furture_death_.csv', index = True, header=True)
    ...
    cases_mean.to_csv ('results/'+foldername+'_prediction/daily_cases_mean_.csv', index = False, header=True)
    cases_lower.to_csv ('results/'+foldername+'_prediction/daily_cases_lowerBound_.csv', index = False, header=True)
    cases_higher.to_csv ('results/'+foldername+'_prediction/daily_cases_upperBound_.csv', index = False, header=True)
...
#    results_death= pd.merge(results_death, death_higher_col, how='outer', on=['Province_State', 'date'])
    results_cases.to_csv ('results/'+foldername+'_prediction/'+foldername+'__daily_cases_.csv', index = True, header=True)
