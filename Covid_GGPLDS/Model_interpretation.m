function Model_interpretation(m_ikj,r,theta,psi,K_prime,X_orig_avg1,S0,S,K,W,Z,D,T,dataset_name)
...
%                 end
                for j =1:6
                    ...
                    ylim([-6 5])
                    hold on
                    title(['Community ',num2str(i)],'FontSize', 12)
           ...
           % figure;
            for j =1:6
                ...
                ylabel('y','FontSize', 12)
                xlabel('x','FontSize', 12)
                title('Communities sum vs Real data','FontSize', 9)
    ...
    if strcmp(data_type,'FHZ')
        if strcmp(method,'overlap')
            ...
            figure;plot(St_community_new(1,20:end,1),St_community_new(1+community_length_row(1),20:end,2))%,St_community_new(1+community_length_row(1)+community_length_row(2),:,3))
            for cc = 1:6
                    temptemp(:,:,cc)=D_new* St_community_new(:,:,cc);        
            end
